...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">Pick up</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Your address</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">Pick up only</h3>
        <div>
